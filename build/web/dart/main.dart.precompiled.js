...
["PuzzleAttempt", "main.dart", , G, {
  ...
  initWebSocket: function(retrySeconds) {
    ...
    $.ws = t2;
    t1 = new G.initWebSocket_scheduleReconnect(t1, retrySeconds);
    t2 = H.setRuntimeTypeInfo(new W._EventStream(t2, C.EventStreamProvider_open._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new G.initWebSocket_closure()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = $.ws;
    t2.toString;
    t2 = H.setRuntimeTypeInfo(new W._EventStream(t2, C.EventStreamProvider_close._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new G.initWebSocket_closure0(retrySeconds, t1)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = $.ws;
    t2.toString;
    t2 = H.setRuntimeTypeInfo(new W._EventStream(t2, C.EventStreamProvider_error._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new G.initWebSocket_closure1(t1)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = $.ws;
    t2.toString;
    t2 = H.setRuntimeTypeInfo(new W._EventStream(t2, C.EventStreamProvider_message._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new G.initWebSocket_closure2()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
  },
  main: [function() {
    $.game = G.Game$();
    G.initWebSocket(2);
  ...
  Distractor: {
    "^": "Object;_width,_height,_targetX,_targetY,_compareX,_compareY,_dragging,img,random,x,y,heading,disSpeed,moving,dragLocation,location,type,newX,newY",
    animate$0: function(_) {
      var t1, t2, t3, dist, t4, head;
      if (!this.moving) {
        this.disSpeed = 1;
        t1 = this.newX;
        t2 = this.x;
        ...
        t3 = this.newX;
        t4 = this.x;
        head = Math.atan2(t1 - t2, t3 - t4);
        if (dist >= this.disSpeed) {
          t1 = Math.cos(head);
          t2 = this.disSpeed;
          t3 = Math.sin(head);
          t4 = this.disSpeed;
          ...
          this.y += t2 * dist;
          t2 = this.random;
          this.newX = t2.nextInt$1($.game.width);
          this.newY = t2.nextInt$1($.game.height);
        }
      }
    },
    draw$1: function(ctx) {
      ...
      if (typeof t2 !== "number")
        return t2.$negate();
      ctx.drawImage(t1, -t3 / 2, -t2 / 2);
      ctx.restore();
    },
    containsTouch$1: function(c) {
      var tx, ty, t1, t2, t3, t4, bx, by;
      tx = c.touchX;
      ty = c.touchY;
      t1 = this.x;
      t2 = this.img;
    ...
    touchUp$1: function(c) {
      ...
      if (c.touchX === this._compareX && c.touchY === this._compareY) {
        t1 = $.game;
        t1.score -= 10;
        t1.touched.push(this.type);
        this.moving = false;
      }
    },
  ...
  Game: {
    "^": "TouchLayer;canvas,random,ctx,width,height,datalogger,pieces,distractors,piece,distractor,trial1,trial2,trial3,trial4,title,phase,id,totalTimeCounter,touched,order,others,order2,others2,order3,others3,score,complete,touchables,touch_bindings",
    draw$0: function() {
      var t1, t2;
      switch (this.phase) {
        case "TITLE":
          t1 = this.title;
          t2 = this.ctx;
          J.clearRect$4$x(t2, 0, 0, this.width, this.height);
          t2.fillStyle = "black";
          t2.drawImage(t1.myIntro.img, 200, 200);
          break;
        case "TRIAL ONE":
          this.trial1.draw$3(this.ctx, this.width, this.height);
          break;
        case "TRIAL TWO":
          this.trial2.draw$3(this.ctx, this.width, this.height);
          break;
        case "TRIAL THREE":
          this.trial3.draw$3(this.ctx, this.width, this.height);
          break;
        case "TRIAL FOUR":
          this.trial4.draw$3(this.ctx, this.width, this.height);
          break;
      }
    },
    animate$0: function(_) {
      switch (this.phase) {
        case "TITLE":
          ...
          break;
        case "TRIAL ONE":
          this.trial1.animate$0(0);
          this.draw$0();
          break;
        case "TRIAL TWO":
          this.trial2.animate$0(0);
          this.draw$0();
          break;
        case "TRIAL THREE":
          this.trial3.animate$0(0);
          this.draw$0();
          break;
        case "TRIAL FOUR":
          this.trial4.animate$0(0);
          this.draw$0();
          break;
      }
    },
    transition$0: function() {
      switch (this.phase) {
        case "TITLE":
          this.phase = "TRIAL ONE";
          P.Timer_Timer$periodic(P.Duration$(0, 0, 0, 0, 0, 1), new G.Game_transition_closure(this));
          C.JSArray_methods.set$length(this.touched, 0);
          $.game.draw$0();
          break;
        case "TRIAL ONE":
          this.phase = "TRIAL TWO";
          P.Timer_Timer$periodic(P.Duration$(0, 0, 0, 0, 0, 1), new G.Game_transition_closure0(this));
          ++this.id;
          this.datalog$0();
          $.ws.send("newtrial");
          this.score = 100;
    ...
    datalog$0: function() {
      ...
      t1.id = t2;
      t1.score = this.score;
      t1.time = this.totalTimeCounter;
      t1.touched = this.touched;
      data = "" + t2 + ", " + t1.score + ", " + t1.time + ", " + H.S(t1.touched);
      $.ws.send(data);
    },
    Game$0: function() {
      var t1, t2, t3;
      ...
      this.phase = "TRIAL ONE";
      this.trial1 = G.Trial$(this.order, this.others);
      this.trial2 = G.Trial$(this.order2, this.others2);
      t1 = this.order3;
      t2 = this.others3;
      this.trial3 = G.Trial$(t1, t2);
      this.trial4 = G.Trial$(t1, t2);
      t2 = H.setRuntimeTypeInfo([], [G.TouchLayer]);
      t1 = P.LinkedHashMap_LinkedHashMap(null, null, null, P.$int, G.TouchBinding);
      t3 = W.ImageElement_ImageElement(null, null, null);
      J.set$src$x(t3, "images/title.png");
      t3 = new G.Title(new G.TouchManager(false, null, t2, t1), new G.IntroTouch(t3), H.setRuntimeTypeInfo([], [G.Touchable]), P.LinkedHashMap_LinkedHashMap(null, null, null, P.$int, G.Touchable));
      t3.Title$0();
      this.title = t3;
      t3 = new G.DataLogger(null, null, null, null);
      t3.DataLogger$0();
      this.datalogger = t3;
      P.Timer_Timer$periodic(C.Duration_40000, new G.Game_closure(this));
    },
    static: {"^": "Game_rand", Game$: function() {
        var t1 = new G.Game(null, C.C__JSRandom, null, null, null, null, H.setRuntimeTypeInfo([], [G.Piece]), H.setRuntimeTypeInfo([], [G.Distractor]), null, null, null, null, null, null, null, null, 0, 0, H.setRuntimeTypeInfo([], [P.String]), ["red", "blue", "green"], ["circleRed", "circleBlue", "circleGreen"], ["red", "blue", "green", "purple"], ["circleRed", "circleBlue", "circleGreen", "circlePurple"], ["blue", "green", "purple"], ["circleBlue", "circleGreen", "circlePurple"], 100, 0, H.setRuntimeTypeInfo([], [G.Touchable]), P.LinkedHashMap_LinkedHashMap(null, null, null, P.$int, G.Touchable));
        t1.Game$0();
        return t1;
      }}
  },
  ...
  Game_transition_closure: {
    "^": "Closure:9;this_0",
    call$1: function(e) {
      return this.this_0.totalTimeCounter++;
    }
  },
  Game_transition_closure0: {
    "^": "Closure:9;this_1",
    call$1: function(e) {
      return this.this_1.totalTimeCounter++;
    }
  },
  initWebSocket_scheduleReconnect: {
    "^": "Closure:0;box_0,retrySeconds_1",
    call$0: function() {
      var t1, t2;
      t1 = this.box_0;
      if (!t1.reconnectScheduled_0) {
        t2 = this.retrySeconds_1;
        P.Timer_Timer(P.Duration$(0, 0, 0, 1000 * t2, 0, 0), new G.initWebSocket_scheduleReconnect_closure(t2));
      }
      t1.reconnectScheduled_0 = true;
    }
  },
  initWebSocket_scheduleReconnect_closure: {
    "^": "Closure:10;retrySeconds_2",
    call$0: function() {
      return G.initWebSocket(this.retrySeconds_2 * 2);
    }
  },
  ...
  initWebSocket_closure0: {
    "^": "Closure:9;retrySeconds_3,scheduleReconnect_4",
    call$1: function(e) {
      P.print("Websocket closed, retrying in " + this.retrySeconds_3 + " seconds");
      this.scheduleReconnect_4.call$0();
    }
  },
  initWebSocket_closure1: {
    "^": "Closure:9;scheduleReconnect_5",
    call$1: function(e) {
      P.print("Error connecting to ws");
      this.scheduleReconnect_5.call$0();
    }
  },
  initWebSocket_closure2: {
    "^": "Closure:11;",
    call$1: function(e) {
      P.print("Received message: " + H.S(J.get$data$x(e)));
    }
  },
  Piece: {
    "^": "Object;x,y,heading,pieceSpeed,random,img,pieceType,dragLocation,location,square,score,_width,_height,_targetX,_targetY,_compareX,_compareY,_dragging,leftNeighbor,rightNeighbor,leftBuddy?,rightBuddy?,newY,newX,moving",
    move$2: function(dx, dy) {
      var t1;
      this.x += dx;
      this.y += dy;
      t1 = this.leftNeighbor;
      if (t1 != null)
        t1.leftMove$2(dx, dy);
      t1 = this.rightNeighbor;
      if (t1 != null)
        t1.rightMove$2(dx, dy);
    },
    rightMove$2: function(dx, dy) {
      var t1;
      this.x += dx;
      this.y += dy;
      t1 = this.rightNeighbor;
    ...
    snap$0: function() {
      ...
      if (typeof t2 !== "number")
        return H.iae(t2);
      t3 = this.leftNeighbor;
      if (t3 != null) {
        t3.x = t1 - t4;
        t3.y = this.y;
        t1 = t3.rightBuddy.leftBuddy.x;
        t4 = J.get$width$x(t3.img);
        if (typeof t4 !== "number")
          return H.iae(t4);
        t6 = t3.leftNeighbor;
        if (t6 != null) {
      ...
      if (t1 != null) {
        t1.x = t5 + t2;
        t1.y = this.y;
        t2 = t1.leftBuddy.rightBuddy.x;
        t3 = J.get$width$x(t1.img);
        if (typeof t3 !== "number")
          return H.iae(t3);
        t4 = t1.rightNeighbor;
        if (t4 != null) {
    ...
    animate$0: function(_) {
      var t1, t2, t3, dist, t4, head;
      if (this.rightNeighbor == null && !this.moving) {
        this.pieceSpeed = 1;
        t1 = this.newX;
        t2 = this.x;
        t1 = Math.pow(t1 - t2, 2);
        ...
        t4 = this.x;
        head = Math.atan2(t1 - t2, t3 - t4);
        if (dist >= this.pieceSpeed) {
          t1 = Math.cos(head);
          t2 = this.pieceSpeed;
          this.move$2(t1 * t2, Math.sin(head) * this.pieceSpeed);
        } else {
          t1 = Math.cos(head);
          this.move$2(t1 * dist, Math.sin(head) * dist);
          t1 = this.random;
          this.newX = t1.nextInt$1($.game.width);
          this.newY = t1.nextInt$1($.game.height);
        }
      }
    },
    draw$1: function(ctx) {
    ...
    touchUp$1: function(c) {
      ...
      if (c.touchX === this._compareX && c.touchY === this._compareY) {
        t1 = this.rightBuddy;
        if (t1 != null && this.leftBuddy != null) {
          t2 = t1.x + 10;
          t3 = this.x;
          if (t2 >= t3)
            if (t1.y + 10 >= this.y) {
        ...
        $.game.touched.push(this.pieceType);
        this.moving = false;
      }
    },
    touchDrag$1: function(c) {
      ...
      t4 = c.touchX;
      this._targetX = t4;
      this._targetY = c.touchY;
      this.dragLocation = t4;
      this.moving = true;
      $.game.draw$0();
    },
    touchSlide$1: function(c) {
  ...
  Title: {
    "^": "TouchLayer;tmanager,myIntro,touchables,touch_bindings",
    animate$0: function(_) {
    },
    Title$0: function() {
      var t1 = this.tmanager;
      t1.registerEvents$1(document.documentElement);
      t1.layers.push(this);
      this.touchables.push(this.myIntro);
    }
  },
  IntroTouch: {
    "^": "Object;img",
    containsTouch$1: function(c) {
      var tx, ty, t1, t2, bx, by;
      tx = c.touchX;
      ty = c.touchY;
      t1 = this.img;
      t2 = J.getInterceptor$x(t1);
  ...
  TouchManager: {
    ...
    findTouchTarget$1: function(tp) {
      ...
      for (t1 = this.layers, i = t1.length - 1; i >= 0; --i) {
        ...
        if (t != null) {
          if (i >= t1.length)
            return H.ioore(t1, i);
          return new G.TouchBinding(t1[i], t);
        }
      }
      return;
    },
    registerEvents$1: function(element) {
      ...
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new G.TouchManager_registerEvents_closure(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = t1.get$onMouseUp(element);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new G.TouchManager_registerEvents_closure0(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t1 = t1.get$onMouseMove(element);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new G.TouchManager_registerEvents_closure1(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(element, C.EventStreamProvider_touchstart._eventType, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new G.TouchManager_registerEvents_closure2(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = C.EventStreamProvider_touchmove._eventType;
      t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(element, t1, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new G.TouchManager_registerEvents_closure3(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(element, C.EventStreamProvider_touchend._eventType, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new G.TouchManager_registerEvents_closure4(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t1 = H.setRuntimeTypeInfo(new W._EventStream(document, t1, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new G.TouchManager_registerEvents_closure5()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    _touchDown$1: function(tframe) {
      var t1, t, target;
      for (t1 = J.get$iterator$ax(J.get$changedTouches$x(tframe)); t1.moveNext$0();) {
        t = G.Contact$fromTouch(t1._html$_current, this.parent);
        target = this.findTouchTarget$1(t);
        if (target != null)
          if (target.touchable.touchDown$1(t))
            this.touch_bindings.$indexSet(0, t.id, target);
      }
    },
    _touchUp$1: function(tframe) {
      ...
      for (t1 = J.get$iterator$ax(J.get$changedTouches$x(tframe)), t2 = this.touch_bindings; t1.moveNext$0();) {
        t = G.Contact$fromTouch(t1._html$_current, this.parent);
        target = t2.$index(0, t.id);
        if (target != null) {
          target.touchUp$1(t);
          t2.$indexSet(0, t.id, null);
        }
      }
  ...
  TouchManager_registerEvents_closure0: {
    ...
    call$1: function(e) {
      ...
      target = t2.$index(0, -1);
      if (target != null)
        target.touchUp$1(G.Contact$fromMouse(e));
  ...
  TouchLayer: {
    ...
    findTouchTarget$1: function(tp) {
      var c, t1, i;
      c = new G.Contact(null, -1, 0, 0, false, false, false, false, false);
      c.Contact$copy$1(tp);
  ...
  Contact: {
    ...
    static: {Contact$fromMouse: function(mouse) {
        var t1 = new G.Contact(null, -1, 0, 0, false, false, false, false, false);
  ...
  Trial: {
    "^": "TouchLayer;random,tmanager,pieces,distractors,piece,distractor,touchables,touch_bindings",
    animate$0: function(_) {
      var t1;
      for (t1 = this.pieces, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();)
        J.animate$0$x(t1._current);
      for (t1 = this.distractors, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();)
        J.animate$0$x(t1._current);
    },
    draw$3: function(ctx, width, height) {
      var t1, t2;
      J.getInterceptor$x(ctx).clearRect$4(ctx, 0, 0, width, height);
      ctx.fillStyle = "white";
      ctx.font = "30px sans-serif";
      ctx.textAlign = "left";
      ctx.textBaseline = "center";
      C.CanvasRenderingContext2D_methods.fillText$3(ctx, "Puzzle Attempt: ", 100, 50);
      C.CanvasRenderingContext2D_methods.fillText$3(ctx, "Score: " + $.game.score, 100, 100);
      t1 = this.pieces;
      if ($.game.complete === t1.length - 1) {
        C.CanvasRenderingContext2D_methods.fillText$3(ctx, "Complete!!", 100, 150);
        t2 = $.game;
        t2.complete = 0;
        t2.transition$0();
      }
    ...
    Trial$2: function(order, others) {
      var t1, t2, t3, t4, z, other, t5, otherY, t6, item, t7, square, x;
      t1 = this.tmanager;
      t1.registerEvents$1(document.documentElement);
      t1.layers.push(this);
      for (t1 = new H.ListIterator(others, others.length, 0, null), t2 = this.distractors, t3 = this.touchables, t4 = this.random, z = 0; t1.moveNext$0();) {
        other = t1._current;
        z += 100;
        t5 = t4.nextInt$1(100);
        otherY = t4.nextInt$1(300);
        t6 = W.ImageElement_ImageElement(null, null, null);
        t5 = new G.Distractor(0, 0, null, null, null, null, false, t6, C.C__JSRandom, t5 + z, otherY, 0, null, false, null, null, other, null, null);
        J.set$src$x(t6, "images/" + H.S(other) + ".png");
        t5.disSpeed = 1;
        t5.newX = C.C__JSRandom.nextInt$1(500);
        t5.newY = C.C__JSRandom.nextInt$1(500);
        t2.push(t5);
        t3.push(t5);
      }
      for (t1 = new H.ListIterator(order, order.length, 0, null), t2 = this.pieces; t1.moveNext$0();) {
        item = t1._current;
        t5 = t4.nextInt$1(500);
        t6 = t4.nextInt$1(500);
        t7 = W.ImageElement_ImageElement(null, null, null);
        t6 = new G.Piece(t5 + 50, t6 + 50, 0, null, C.C__JSRandom, t7, item, null, null, null, 100, 0, 0, null, null, null, null, false, null, null, null, null, null, null, false);
        J.set$src$x(t7, "images/" + H.S(item) + ".png");
        t6.pieceSpeed = 1;
        t6.newX = C.C__JSRandom.nextInt$1(500);
        t6.newY = C.C__JSRandom.nextInt$1(500);
        t2.push(t6);
        t3.push(t6);
      }
      for (t1 = new H.ListIterator(t2, t2.length, 0, null); t1.moveNext$0();) {
        square = t1._current;
        x = H.Lists_indexOf(t2, square, 0, t2.length);
        t3 = x === 0;
        if (t3) {
          t4 = x + 1;
          if (t4 < 0 || t4 >= t2.length)
            return H.ioore(t2, t4);
          square.set$rightBuddy(t2[t4]);
        }
        t4 = t2.length;
        if (x === t4 - 1) {
          t5 = x - 1;
          ...
          square.set$leftBuddy(t2[t5]);
        }
        if (!t3 && x !== t2.length - 1) {
          t3 = x - 1;
          if (t3 < 0 || t3 >= t2.length)
            return H.ioore(t2, t3);
          square.set$leftBuddy(t2[t3]);
          t3 = x + 1;
          if (t3 < 0 || t3 >= t2.length)
            return H.ioore(t2, t3);
          square.rightBuddy = t2[t3];
        }
      }
    },
    static: {"^": "Trial_rand", Trial$: function(order, others) {
        var t1 = new G.Trial(C.C__JSRandom, new G.TouchManager(false, null, H.setRuntimeTypeInfo([], [G.TouchLayer]), P.LinkedHashMap_LinkedHashMap(null, null, null, P.$int, G.TouchBinding)), H.setRuntimeTypeInfo([], [G.Piece]), H.setRuntimeTypeInfo([], [G.Distractor]), null, null, H.setRuntimeTypeInfo([], [G.Touchable]), P.LinkedHashMap_LinkedHashMap(null, null, null, P.$int, G.Touchable));
        t1.Trial$2(order, others);
        return t1;
      }}
  }
},
...
G.Piece.$isObject = true;
G.Distractor.$isObject = true;
G.Touchable.$isObject = true;
G.TouchLayer.$isObject = true;
G.TouchBinding.$isObject = true;
...
J.animate$0$x = function(receiver) {
  return J.getInterceptor$x(receiver).animate$0(receiver);
};
...
function dart_precompiled($collectedClasses) {
  ...
  function DataLogger(id, score, time, touched) {
    this.id = id;
    this.score = score;
    this.time = time;
  ...
  function Distractor(_width, _height, _targetX, _targetY, _compareX, _compareY, _dragging, img, random, x, y, heading, disSpeed, moving, dragLocation, location, type, newX, newY) {
    this._width = _width;
    this._height = _height;
    this._targetX = _targetX;
    this._targetY = _targetY;
    this._compareX = _compareX;
    this._compareY = _compareY;
  ...
  Distractor.builtin$cls = "Distractor";
  if (!"name" in Distractor)
    Distractor.name = "Distractor";
  $desc = $collectedClasses.Distractor;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Distractor.prototype = $desc;
  function Game(canvas, random, ctx, width, height, datalogger, pieces, distractors, piece, distractor, trial1, trial2, trial3, trial4, title, phase, id, totalTimeCounter, touched, order, others, order2, others2, order3, others3, score, complete, touchables, touch_bindings) {
    this.canvas = canvas;
    this.random = random;
    this.ctx = ctx;
    this.width = width;
  ...
  function Game_transition_closure(this_0) {
    this.this_0 = this_0;
  }
  Game_transition_closure.builtin$cls = "Game_transition_closure";
  if (!"name" in Game_transition_closure)
    Game_transition_closure.name = "Game_transition_closure";
  $desc = $collectedClasses.Game_transition_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_transition_closure.prototype = $desc;
  function Game_transition_closure0(this_1) {
    this.this_1 = this_1;
  }
  Game_transition_closure0.builtin$cls = "Game_transition_closure0";
  if (!"name" in Game_transition_closure0)
    Game_transition_closure0.name = "Game_transition_closure0";
  $desc = $collectedClasses.Game_transition_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_transition_closure0.prototype = $desc;
  function initWebSocket_scheduleReconnect(box_0, retrySeconds_1) {
    this.box_0 = box_0;
    this.retrySeconds_1 = retrySeconds_1;
  }
  initWebSocket_scheduleReconnect.builtin$cls = "initWebSocket_scheduleReconnect";
  if (!"name" in initWebSocket_scheduleReconnect)
    initWebSocket_scheduleReconnect.name = "initWebSocket_scheduleReconnect";
  $desc = $collectedClasses.initWebSocket_scheduleReconnect;
  if ($desc instanceof Array)
    $desc = $desc[1];
  initWebSocket_scheduleReconnect.prototype = $desc;
  function initWebSocket_scheduleReconnect_closure(retrySeconds_2) {
    this.retrySeconds_2 = retrySeconds_2;
  }
  initWebSocket_scheduleReconnect_closure.builtin$cls = "initWebSocket_scheduleReconnect_closure";
  if (!"name" in initWebSocket_scheduleReconnect_closure)
    initWebSocket_scheduleReconnect_closure.name = "initWebSocket_scheduleReconnect_closure";
  $desc = $collectedClasses.initWebSocket_scheduleReconnect_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  initWebSocket_scheduleReconnect_closure.prototype = $desc;
  function initWebSocket_closure() {
  }
  initWebSocket_closure.builtin$cls = "initWebSocket_closure";
  if (!"name" in initWebSocket_closure)
    initWebSocket_closure.name = "initWebSocket_closure";
  $desc = $collectedClasses.initWebSocket_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  initWebSocket_closure.prototype = $desc;
  function initWebSocket_closure0(retrySeconds_3, scheduleReconnect_4) {
    this.retrySeconds_3 = retrySeconds_3;
    this.scheduleReconnect_4 = scheduleReconnect_4;
  }
  initWebSocket_closure0.builtin$cls = "initWebSocket_closure0";
  if (!"name" in initWebSocket_closure0)
    initWebSocket_closure0.name = "initWebSocket_closure0";
  $desc = $collectedClasses.initWebSocket_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  initWebSocket_closure0.prototype = $desc;
  function initWebSocket_closure1(scheduleReconnect_5) {
    this.scheduleReconnect_5 = scheduleReconnect_5;
  }
  initWebSocket_closure1.builtin$cls = "initWebSocket_closure1";
  if (!"name" in initWebSocket_closure1)
    initWebSocket_closure1.name = "initWebSocket_closure1";
  $desc = $collectedClasses.initWebSocket_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  initWebSocket_closure1.prototype = $desc;
  function initWebSocket_closure2() {
  }
  initWebSocket_closure2.builtin$cls = "initWebSocket_closure2";
  if (!"name" in initWebSocket_closure2)
    initWebSocket_closure2.name = "initWebSocket_closure2";
  $desc = $collectedClasses.initWebSocket_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  initWebSocket_closure2.prototype = $desc;
  function Piece(x, y, heading, pieceSpeed, random, img, pieceType, dragLocation, location, square, score, _width, _height, _targetX, _targetY, _compareX, _compareY, _dragging, leftNeighbor, rightNeighbor, leftBuddy, rightBuddy, newY, newX, moving) {
    this.x = x;
    this.y = y;
    this.heading = heading;
  ...
  Piece.builtin$cls = "Piece";
  if (!"name" in Piece)
    Piece.name = "Piece";
  $desc = $collectedClasses.Piece;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Piece.prototype = $desc;
  Piece.prototype.set$leftBuddy = function(v) {
    return this.leftBuddy = v;
  };
  Piece.prototype.set$rightBuddy = function(v) {
    return this.rightBuddy = v;
  };
  function Title(tmanager, myIntro, touchables, touch_bindings) {
  ...
  function IntroTouch(img) {
    this.img = img;
  }
  IntroTouch.builtin$cls = "IntroTouch";
  if (!"name" in IntroTouch)
    IntroTouch.name = "IntroTouch";
  $desc = $collectedClasses.IntroTouch;
  if ($desc instanceof Array)
    $desc = $desc[1];
  IntroTouch.prototype = $desc;
  ...
  TouchLayer.builtin$cls = "TouchLayer";
  if (!"name" in TouchLayer)
    TouchLayer.name = "TouchLayer";
  $desc = $collectedClasses.TouchLayer;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TouchLayer.prototype = $desc;
  function TouchBinding(layer, touchable) {
    this.layer = layer;
    this.touchable = touchable;
  }
  TouchBinding.builtin$cls = "TouchBinding";
  if (!"name" in TouchBinding)
    TouchBinding.name = "TouchBinding";
  $desc = $collectedClasses.TouchBinding;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TouchBinding.prototype = $desc;
  function Touchable() {
  }
  ...
  function Trial(random, tmanager, pieces, distractors, piece, distractor, touchables, touch_bindings) {
    this.random = random;
    this.tmanager = tmanager;
    this.pieces = pieces;
    this.distractors = distractors;
  ...
  Trial.builtin$cls = "Trial";
  if (!"name" in Trial)
    Trial.name = "Trial";
  $desc = $collectedClasses.Trial;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Trial.prototype = $desc;
